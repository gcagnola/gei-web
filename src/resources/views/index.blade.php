                ...
                <div class="gei-periodo__encabezado">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-end gap-2">
                        ...
                        @switch($estadoMigracion['estado'])
                            @case('OK')
                                <span class="badge text-bg-success">Migrado</span>
                                @break
                            @case('MODIFICADO')
                        ...
                        >
                            ...
                            >
                                @if ($estadoMigracion['estado'] === 'OK')
                                    Migrar nuevamente
                                @elseif ($estadoMigracion['estado'] === 'ERROR')
                                    Reintentar
                                @else
                                    Migrar
                                @endif
    ...
    >
        <div class="gei-migration-panel">
            <div class="d-flex align-items-center gap-3">
                <div class="spinner-border text-primary" role="status" aria-hidden="true"></div>
                <div>
                    <h2 class="h5 mb-1" id="migrationProgressTitle">Migrando a PostgreSQL</h2>
            ...
            <div class="d-flex justify-content-between gap-3 small text-muted mt-3">
                <span>Verificando tablas y procesando registros. No cierres esta ventana.</span>
